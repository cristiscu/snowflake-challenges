...
show tables;
set ts0='2024-01-07 08:09:06.535 -0800'::TIMESTAMP_LTZ;
...
select start_time,
  datediff('minute', $ts0, start_time) as step,
  query_text,
...
with q as (
  select datediff('minute', $ts0, start_time) as step,
